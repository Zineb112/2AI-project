<nav class="navigation-alt ">
    <div class="navigation-alt__logo-box">
        <a href="index.php">
            <img src="assets/images/logo.png" alt="logo 2AI" class="navigation-alt__logo">
        </a>
    </div>
    <ul class="navigation-alt__list">
        <li class="navigation-alt__item"><a href="index.php" class="navigation-alt__link">Accueil</a></li>
        ...
        <li class="navigation-alt__item">
            <a href="gallery.php" class="navigation-alt__link">Galerie</a>
        </li>
        <li class="navigation-alt__item"><a href="news.php" class="navigation-alt__link">Actualités</a></li>
        ...
        <nav class="navigation__nav">
            <ul class="navigation__list">
                ...
                <li class="navigation__item">
                  ...
                  <a href="portailInnov.php" class="navigation__link"> &nbsp; &nbsp;Portail de l'innovation <i class="fa fa-angle-down"></i>&nbsp; &nbsp;</a>
                  <input type="checkbox" id="drop-1">
                  <ul class="navigation__item-sub list-unstyled">
                ...
                <li class="navigation__item">
                  <a href="gallery.php" class="navigation__link">&nbsp; &nbsp; Galerie&nbsp; &nbsp;</a>
                </li>
                <li class="navigation__item">
                  <a href="news.php" class="navigation__link">&nbsp; &nbsp;Actualités&nbsp; &nbsp;</a>
                </li>
                <li class="navigation__item">
