        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                Ajouter un nouveau membre de l'équipe
                    ...
                    En soumettant ce formulaire, vous créerez un nouveau membre de l'équipe
                    </div>
                </div>
            </div>
    ...
    <div class="row justify-content-xl-center">
        <div class="col-md-8">
            <div class="main-card mb-2 card">
                <div class="card-body">
                    <h5 class="card-title">Nouveau membre de l'équipe</h5>
                    <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="" >
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Entrez son compte LinkedIn" name="linkedin"  />
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Entrez son compte Instagram" name="instagram"  />
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
