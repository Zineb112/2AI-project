    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                Ajouter nouveau carnet de l'inventeur
                    <div class="page-title-subheading">
                    En soumettant ce formulaire, vous créerez un nouveau carnet de l'inventeur
                    </div>
                </div>
            </div>
    ...
    <div class="row justify-content-xl-center">
        <div class="col-md-8">
            <div class="main-card mb-2 card">
                <div class="card-body">
                    <h5 class="card-title">Nouveau carnet de l'inventeur</h5>
