    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                Mettre à jour les actualités pour le concept 1
                    <div class="page-title-subheading">
                    En soumettant ce formulaire, vous mettrez à jour les informations des actualités pour le concept 1
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <?php if($newsC1_result): ?>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3"> 
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Ici écrire le titre de l'article" name="title" value="<?php echo $newsC1->title ?>" required="" />
