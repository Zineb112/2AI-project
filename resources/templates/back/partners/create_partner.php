        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                Ajouter nouveau partenaire
                    ...
                    En soumettant ce formulaire, vous créerez un nouveau partenaire 
                    </div>
                </div>
            </div>
                    ...
                    <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="" >
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Ici écrire le nom partenaire" name="partner_name" required="" />
