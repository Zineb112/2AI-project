    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Gérez vos abonnés
                    <div class="page-title-subheading">Ici vous pouvez voir les informations de vos abonnés
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                ...
                <div class="table-responsive" id="newsletter_load">
    ...
    $(document).ready(function () {
        ...
        function load_fn_data(page) {
            $.ajax({
                ...
                data: {
                    page: page,
                    newsletterpagination: "pagination"
                },
                success: function (data) {
                    $('#newsletter_load').html(data);
                }
            });
        }
