  ...
  <div class="inner" data-tilt data-tilt-perspective="2000">
   <div class="menu">
    <ul>
      ...
      <li><a href="carnet.html">Carnet de l'inventeur</a></li>
...
<nav class="navbar">
  ...
  <!-- end left -->
  <div class="logo"> <a href="index.html"><img src="assets_c2/images/logo.png" alt="Image"></a> </div>
  <!-- end logo -->
  <div class="right">
    <ul class="language">
      <li><a href="#"></a></li>
      ...
      <div class="row">
        ...
        <div class="col-12">
            <div class="project-box wow fadeIn" data-bg="#e7f3ff">
                <figure> <a href="images/featured02.jpg" data-fancybox><img src="images/featured01.jpg" alt="Image"></a></figure>
                <div class="content-box">
                  <div class="inner"> <small>Règles de succès</small>
                    <h3><span>Female</span>Purples</h3>
                    <div class="custom-link"> <a href="">
                      <div class="lines"> <span></span> <span></span> </div>
                      <!-- end lines --> 
                      <b>Lire la vidéo</b></a> </div>
                    <!-- end custom-link --> 
                  </div>
                  <!-- end inner --> 
                </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeIn">
        ...
        <h2 data-text="Guide">Un reportage en ligne présentés par des dirigeants d’entreprises /Inve partager, orienter et de guider les jeunes innovateurs vers le monde de l’entreprenariat.</h2>
      </div>
      <!-- end col-12 -->
      <div class="col-12">
        <div class="project-box wow fadeIn" data-bg="#e7f3ff">
          ...
          <div class="content-box">
            <div class="inner"> <small>VERS LE MONDE DE L’ENTREPRENARIAT</small>
              <h3><span>Kyle</span>Watkins</h3>
              <div class="custom-link"> <a href="">
                <div class="lines"> <span></span> <span></span> </div>
                <!-- end lines --> 
                <b>Lire la vidéo</b></a> </div>
