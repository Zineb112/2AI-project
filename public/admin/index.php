...
<div class="app-main">
    ...
    <div class="app-main__outer">
        ...
        if(isset($_GET['manage_portail'])){
        include(TEMPLATE_BACK . DS . "portail/manage_portail.php");
        }
        if(isset($_GET['edit_portail'])){
        ...
        if(isset($_GET['edit_newsC1'])){
        include(TEMPLATE_BACK . DS . "newsC1/edit_newsC1.php");
        }
        // News C2 requestes
        if(isset($_GET['create_newsC2'])){
            include(TEMPLATE_BACK . DS . "newsC2/create_newsC2.php");
        }
        if(isset($_GET['manage_newsC2'])){
            include(TEMPLATE_BACK . DS . "newsC2/manage_newsC2.php");
        }
        if(isset($_GET['edit_newsC2'])){
